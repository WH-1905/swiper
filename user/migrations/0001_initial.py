    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dating_sex', models.CharField(choices=[('M', '男'), ('F', '女')], max_length=8, verbose_name='匹配的性别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_year', models.ImageField(upload_to='')),
                ('birth_month', models.ImageField(upload_to='')),
                ('birth_day', models.ImageField(upload_to='')),
            ],
        ),
    ]
